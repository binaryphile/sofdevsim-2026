...
| --- |
| 
[Wait Group](https://go.dev/wiki/MutexOrChannel#wait-group)

[More Info](https://go.dev/wiki/MutexOrChannel#more-info)
...
-   Channels in Effective Go: [https://go.dev/doc/effective\_go#channels](https://go.dev/doc/effective_go#channels)
-   The sync package: [https://pkg.go.dev/sync/](https://pkg.go.dev/sync/)
